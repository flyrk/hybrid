    ...
    <div className="flex items-center">
      <div className="z-10">
        <svg className="w-24 h-24" xmlns="http://www.w3.org/2000/svg" width="125" height="124" viewBox="0 0 125 124" fill="none">
          <path d="M109.977 39.7417C122.381 66.0479 111.111 97.4291 84.8053 109.834C58.4991 122.238 27.1179 110.969 14.7134 84.6624C2.30886 58.3562 13.5784 26.975 39.8846 14.5705C66.1908 2.16599 97.572 13.4355 109.977 39.7417Z" fill="white" stroke="url(#paint0_linear_214_337)" strokeWidth="18"/>
          <defs>
